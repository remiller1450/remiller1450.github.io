...
Lab = c(" ", " ", paste0("[Lab 1](s209s19/Lab_1.html)"), paste0("[Lab 2](s209s19/Lab_2.html)"), paste0("[Lab 3](s209s19/Lab_3.html)"), " ", " ", paste0("[Lab 4](s209s19/Lab_4.html)"),  paste0("[Lab 5](s209s19/Lab_5.html)"), " ", paste0("[Lab 6](s209s19/Lab_6.html)"), paste0("[Lab 7](s209s19/Lab_7.html)"), " ", paste0("[Lab 8](s209s19/Lab_8.html)"), " ", paste0("[Lab 9](s209s19/Lab_9.html)"), " ", "Lab 10"),

Data = c(paste0("[HappyPlanet](data/HappyPlanet.csv)", ", ", "[AntiquitiesAct](data/AntiquitiesAct.csv)"), " ", paste0("[ClassSurvey](data/ClassSurvey.csv)"), paste0("[DeathPenaltySentencing](data/DeathPenaltySentencing.csv)"),  paste0("[IowaCityHomes](data/IowaCityHomeSales.csv)", ", ", "[ElectionMargin](data/ElectionMargin.csv)"), " ", " ", paste0("[Small Colleges](data/CollegeData.csv)"), paste0("[Parking](data/Parking.csv)", ", ", "[HairEyeColor](data/HairEyeColor.csv)"), " ", paste0("[A/B Testing](data/ab_test.csv)"), paste0("[Lead IQ](data/LeadIQ.csv)", ", ", "[Wetsuits](data/Wetsuits.csv)"), " ", paste0("[Police Killings](data/PoliceKillings.csv)", ", ", "[Golden State Warriors](data/GSWarriors.csv)"), paste0("[Tailgating](data/Tailgating.csv)"), paste0("[TSA Claims](data/TSA_Claims.csv)"),  paste0("[Tips](data/Tips.csv)"), paste0("[Professor Beauty](data/UT-Austin_Professors.csv)")), 

Other = c(rep(" ", 7), paste0("[Exam 1 Review](s209s19/Exam1_rev.pdf)"), paste0("[Final Project Assignment](s209s19/project209.html)"), " ", " ", " ", " ", paste0("[Exam 2 Formula Sheet](s209s19/EXAM2_Formulas.pdf)"), " ", " ", " ", " "))
#library(knitr)
knitr::kable(df209)
```