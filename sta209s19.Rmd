...
```{r, echo = FALSE}
df209 <- data.frame(Topic = c(paste0("[Introduction](s209s19/h1.1.pdf)"), paste0("[Populations and Samples](s209s19/h1.2.pdf)"), paste0("[Descriptive Statistics](s209s19/Lab_1.html)"), paste0("[Randomized Experiments](s209s19/h1.3.pdf)"),  paste0("[Correlation and Regression](s209s19/h2.5.pdf)"), paste0("[Sampling Distributions](s209s19/h3.1N.pdf)"), paste0("[Interval Estimation](s209s19/h3.2.pdf)"), "Bootstrapping", paste0("[Hypothesis Testing](s209s19/h4.1N.pdf)"), paste0("[Testing Errors and Power](s209s19/h.4.4.pdf)"), paste0("[Classical Inference (proportions)](s209s19/h5N.pdf)"), paste0("[Classical Inference (means)](s209s19/h6N.pdf)")), 
                    
Lab = c(" ", " ", paste0("[Lab 1](s209s19/Lab_1.html)"), paste0("[Lab 2](s209s19/Lab_2.html)"), paste0("[Lab 3](s209s19/Lab_3.html)"), " ", " ", paste0("[Lab 4](s209s19/Lab_4.html)"),  paste0("[Lab 5](s209s19/Lab_5.html)"), " ", paste0("[Lab 6](s209s19/Lab_6.html)"), paste0("[Lab 7](s209s19/Lab_7.html)")),
