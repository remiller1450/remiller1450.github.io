...
x = data.frame(Date = c("3/14", "4/2", "4/4", "4/9", "4/11", "4/16", "4/18"), 
               Lecture = c(" ","[Linear Regression and Gradient Descent Algorithms](ml24/lm.pdf)", "[Logistic and Softmax Regression](ml24/glm.pdf)", "[Regularization and Regression](ml24/lasso.pdf)", "Artificial Neural Networks", "Review/catch up", "Exam"),
