...
x = data.frame(Date = c("3/14", "4/2", "4/4", "4/9", "4/11", "4/16", "4/18"), 
               Lecture = c(" ","[Linear Regression and Gradient Descent Algorithms](ml24/lm.pdf)", "Logistic and Softmax Regression", "Regularized Regression", "Artificial Neural Networks", "Review/catch up", "Exam"),
               Lab = c("[Linear Algebra and Calculus Review (optional)](ml24/linear.html)", "[Lab 12 - Linear Regression and Gradient Descent](ml24/lab12_lm.html)", "Logistic Regression", "Lasso, Ridge, and Elastic Net", " ", " ", "Exam"))
kable(x) %>%
  kable_styling(bootstrap_options = c("hover"))
```

- The optional lab (linear and algebra and calculus review) is due Tuesday 4/2
- Labs 12 and 13 are due Tuesday 4/9
- [Homework 4](ml24/hw4.html) is due Tuesday 4/16
