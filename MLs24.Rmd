...
x = data.frame(Date = c("2/6", "2/8", "2/13", "2/15"), 
               Lecture = c("[Training, Validation, and KNN](ml24/val.pdf)", "Cross-validation", "Decision Trees", "Support Vector Machines"),
               Lab = c("[Lab 4 - Workflow and pipelines](ml24/Lab4_workflow.html)", "Lab 5 - Cross-validation and Classifier performance", "Lab 6 - Model comparisons", " "))
kable(x) %>%
  kable_styling(bootstrap_options = c("hover"))
```
...
- Lab 4 is due on Friday 2/9 at 11:59pm
- Labs 5 and 6 are due on Friday 2/15 at 11:59pm
- [Homework 2](ml24/hw2.html) due Tuesday 2/20 at 1:00pm
    - Please submit a Jupyter Notebook via P-web containing all code and written responses
