...
x = data.frame(Date = c("2/6", "2/8", "2/13", "2/15"), 
               Lecture = c("Training, Validation, and KNN", "Classification", "Decision Trees", "Support Vector Machines"),
               Lab = c("Lab 4 - Cross-validation and pipelines", "Lab 5 - Classifier performance", "Lab 6 - Model comparisons", " "))
kable(x) %>%
  kable_styling(bootstrap_options = c("hover"))
```
