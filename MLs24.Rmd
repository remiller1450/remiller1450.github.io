...
x = data.frame(Date = c("2/6", "2/8", "2/13", "2/15", "2/20", "2/22"), 
               Lecture = c("[Training, Validation, and KNN](ml24/val.pdf)", " ", "[Cross-validation](ml24/cv.pdf)", "[Classifier Performance](ml24/perform.pdf)", "Decision Trees", "Support Vector Machines"),
               Lab = c("[Lab 4 - Workflow and pipelines](ml24/Lab4_workflow.html)", "Continue Lab 4", "[Lab 5 - Cross-validation](ml24/lab5_cv.html)", "[Lab 6 - Classifier Performance](ml24/lab6_perform.html)", "Lab 7 - Decision Trees", "Lab 8 - Comparing many models"))
kable(x) %>%
  kable_styling(bootstrap_options = c("hover"))
```
...
x = data.frame(Date = c("2/27", "2/29"), 
               Lecture = c("Random Forests", "Boosting"),
               Lab = c("Ensembles and Stacking", "XGBoost"))
kable(x) %>%
  kable_styling(bootstrap_options = c("hover"))
```
...
x = data.frame(Date = c("3/5", "3/7", "3/12", "3/14", "4/2", "4/4"), 
