...
x = data.frame(Date = c("2/29", "3/5", "3/7"), 
               Lecture = c("[Random Forests](ml24/rf.pdf)", "Boosting", " "),
               Lab = c("[Ensembles and Stacking](ml24/lab9_ensembles.html)", "XGBoost", "Feature Engineering"))
kable(x) %>%
  kable_styling(bootstrap_options = c("hover"))
```
...
- [Homework 3](ml24/hw3.html) is dues Tuesday 4/2 at 11:59pm
