...
x = data.frame(Date = c("2/6", "2/8", "2/13", "2/15", "2/20", "2/22"), 
               Lecture = c("[Training, Validation, and KNN](ml24/val.pdf)", " ", "[Cross-validation](ml24/cv.pdf)", "[Classifier Performance](ml24/perform.pdf)", "[Decision Trees](ml24/trees.pdf)", "Support Vector Machines"),
               Lab = c("[Lab 4 - Workflow and pipelines](ml24/Lab4_workflow.html)", "Continue Lab 4", "[Lab 5 - Cross-validation](ml24/lab5_cv.html)", "[Lab 6 - Classifier Performance](ml24/lab6_perform.html)", "[Lab 7 - Decision Trees](ml24/lab7_trees.html)", "Lab 8 - SVMs"))
kable(x) %>%
  kable_styling(bootstrap_options = c("hover"))
```
...
- Labs 5 and 6 are due on Tuesday 2/20 at 11:59pm
- Labs 7 and 8 are due on Friday 2/23 at 11:59pm
- [Homework 2](ml24/hw2.html) due *Tuesday* 2/27 at 1pm
    - Please submit a Jupyter Notebook via P-web containing all code and written responses
