...
x = data.frame(Date = c("3/14", " "," ", " ", " ", " ", " "), 
               ...
               Lab = c("[Linear Algebra and Calculus Review (optional)](ml24/linear.html)", "Gradient Descent Algorithms", "Regression", "Lasso, Ridge, and Elastic Net", "Feature Expansion", " ", "Backpropagation"))
kable(x) %>%
  kable_styling(bootstrap_options = c("hover"))
```
