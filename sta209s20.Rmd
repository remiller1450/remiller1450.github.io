...
The readings listed below are *recommended* (but not required) prior to the date indicated. It has been my observation that students who complete these readings have been the most successful.
...
Homework is generally due *at the start of class* every Friday (with a few exceptions near exams). You may always turn-in an assignment early, but if you'd like to request an extension to turn-in an assignment late you must contact me at least 24-hours prior to the posted deadline *and* you must submit the assignment electronically (scanned or typed and submitted via email).  
