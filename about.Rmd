...
1. Most summers I supervise 1-2 two research projects involving 2-4 students. Preliminary topics for these projects are determined in early February, but they can be adjusted depending upon student interests and abilities.
...
1. Understanding and extracting comprehensible eye-movement features using convolution-based deep learning methods (ROCKET and InceptionTime), essentially an explainable AI task (XAI) involving the development of specialized methods.
