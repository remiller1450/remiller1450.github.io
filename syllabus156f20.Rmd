...
This course will follow the textbook listed below.  Homework will be assigned from the text, but readings from the will be optional.

- *Stats, data & models* 5th edition by DeVeaux, Vellemen, and Bock

### Website

- Materials can be found the course Canvas page, many of these may simply be links to: https://remiller1450.github.io/m156f20.html, where you will find everything needed for the course (other than grades and online quizzes)
...
- Exam 1 (in-class) - 20%
- Exam 2 (in-class) - 20%
- Final Exam (cumulative take-home) 20%
