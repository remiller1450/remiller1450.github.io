...
- Organizational structures and workflow (1/23)
...
- [Project reflection](s395s20/proj_pref.html)
    ...
    - [Click here](s395s20/s395_topics.html) to view project descriptions
...
- Tuesday 2/4 - First progress meetings for Groups #1 and #2 during class
- Tuesday 2/11 - First progress meetings for Group #3 and #4 during class
...
```{r, echo = FALSE}
tab <- data.frame(FirstTues = c("Progress Reports (1 + 2)", "Advisor Assessment of progress (3 + 4)", "Time to work/organize"),
                  FirstThurs = c("Goal Setting (1 + 2)", "Advisor Assessment of goals (3 + 4)", "Time to work/organize"),
                  SecondTues = c("Progress Reports (3 + 4)", "Advisor Assessment of progress (1 + 2)", "Time to work/organize"),
                  SecondThurs = c("Goal Setting (3 + 4)", "Advisor Assessment of goals (1 + 2)", "Time to work/organize"))
