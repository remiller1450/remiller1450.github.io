...
# Syllabus - Sta-395 Intro to ML (Fall '26)
...
Roughly once per 2-3 weeks we will deviate from our typical lecture/lab sessions and have paper discussions. Each discussion involves two influential papers, you are expected to read both. During class, you and a partner will be discussion leaders for one paper and discussion participants for the other paper. 

As a discussion leader it is your responsibility to develop insightful questions that facilitate a productive discussion of the main contributions of each paper as well as how they relate to what we've learned this semester. As a discussion participant it is your responsibility to thoughtfully engage with the discussion leaders. After these small-group discussions, you will summarize your group's conversation for the class and then rate the preparedness and understanding of yourself and each of your group members.
...
There will be 5 conceptually-focused quizzes, most of which are concentrated in the early weeks of the semester. These are intended to take no more than 15-minutes and involve a variety short-answer and multiple choice questions that should be fairly easy to answer correctly if you've stayed on top of recent topics. The purpose of these quizzes is to ensure you take the time to internalize essential concepts that someone who is trained in machine learning should be able to recall without needing to look up an answer. Your lowest score on these quizzes will be dropped.

**In-class Paper Discussions** - 10\%
...
1. Statistical Modeling: The Two Cultures - [link](https://www.jstor.org/stable/2676681?seq=1) and A Study of Cross-Validation and Bootstrap for Accuracy Estimation and Model Selection - [link](https://robotics.stanford.edu/~ronnyk/accEst.pdf)
2. Coming Soon
