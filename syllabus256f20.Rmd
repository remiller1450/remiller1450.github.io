...
Due to COVID-19 concerns, students will attend *every other* in-person class sessions.  Meaning if you sign-up for group A, you'll attend Monday and Friday of Week 1 and Wednesday of Week 2.  If you sign up for group B, you'll attend Wednesday of Week 1 and Monday and Friday of Week 2.  

Please note that adjacent sessions will mirror each other, so there is no practical difference between group A and group B.  In fact, if you have to miss your session you request permission to attend the other that week (noting that our classroom capacity is 10 students).

Prior to each in-person session you are expected to do the following:

- Watch a series of short lecture videos on your own
- Take an online comprehension quiz covering the videos (can retake twice)

To reiterate, each week you are expected to watch the lecture videos and take the comprehension quiz *before* attending class.  During in-person class sessions you will practice concepts from these lectures, often by analyzing real data as part of a small group.
