...
- On Tuesdays two groups will present their work since their most recent update (approximately 20-minutes per group). After these presentations, the remaining groups will meet with the group they are advising to discuss the future direction of the project. 
- The advisory groups will summarize Tuesday's discussion, add additional critiques, and share a short briefing with the entire class on Thursday (approximately 5-minutes per group) 
- Also on Thursdays, groups and advisory groups then reconvene and form goals to be achieved by the next progress briefing. 
- This schedule will repeat, alternating the roles of groups 1 and 3, and groups 2 and 4 each. 
- Any extra time during a class session will be used for organization/planning.