...
- Working with strings
    ...
    - <span style="color: red;"> Lab 8 is due Wednesday 9/21 by 11:59 pm \span
- Interactive data visualizations
    - Lab #9 - Intro to `plotly`
    - Lab #10 - Making maps with `leaflet`
    - Labs 9 and 10 are due Friday 9/30 by 11:59pm
...
- Homework #3 (coming soon, start with Question #5 from HW 2)
    - Topics: string processing, `plotly`, `leaflet`
    - <span style="color: red;"> Due date: Monday 10/3 at 11:59pm \span
- Homework #4
