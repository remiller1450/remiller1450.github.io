...
- Modeling a numeric outcome
    ...
    - <span style="color: red;"> Labs 15 and 16 are due Wednesday 11/16 by 11:59pm \span
- Modeling a categorical outcome
    - Lab #17 - Logistic regression
    - Lab #18 - Evaluating model accuracy
    - Labs 17 and 18 are due Wednesday 11/23 by 11:59pm
- Tree-based models
...
- [Homework #6](s230f22/hw6.html)
    ...
    - <span style="color: red;"> Due date: Monday 11/21 at 11:59pm \span
- Homework #7
