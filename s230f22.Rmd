...
- Modeling a numeric outcome
    ...
    - <span style="color: red;"> Labs 15 and 16 are due Friday 11/18 by 11:59pm \span
- Modeling a categorical outcome
    - Lab #17 - Logistic regression and binary classification
    - Lab #18 - Introduction to decision trees
    - Lab #19 - Other tree-based models
    - Labs 17, 18, and 19 are due Friday 12/2 by 11:59pm
