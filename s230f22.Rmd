...
- Principal component analysis
    - Lab #11 - Principal components analysis (part 1)
    - Lab #12 - Principal components analysis (part 2)
    - <span style="color: red;"> Labs 11 and 12 are due Monday 10/31 by 11:59pm \span
- Clustering
    - Lab #13 - Segmentation methods
    - Lab #14 - Hierarchical methods
- Modeling a numeric outcome
    - Lab #14 - Linear regression and K-nearest neighbors
    - Lab #15 - Cross-validation
- Modeling a categorical outcome
    - Lab #16 - Logistic regression
    - Lab #17 - Expressing model accuracy
- Tree-based models
