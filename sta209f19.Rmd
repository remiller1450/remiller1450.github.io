...
- Exam #2 will be Friday 11/15 during class
    - Some study materials are posted on p-web
    - On *Friday 11/8* we will review for the exam during class, please respond this survey: https://forms.gle/CPET7JHxqkido8Hd6 if there are certain topics from the study guide that you'd like this review to focus on (completing this survey is optional).
