...
This course is collaborative, meaning attendence is *critical*  All absences permitted by the college (athletics, religious observation, etc.) must be communicated as early as possible and will not count against you. All other absences (illness, job interviews, etc.) can negatively impact your grade if they become excessive. The schedule shown below summarizes the impact of these absences:

- 1-4 absences - No impact so long as they are communicated in advance or accompanied by appropriate documentation (doctor's note, etc.)
