...
- Consider an application large number of predictor variables (say $p = 600$)
...
- Another thought is that cross-validation might be able to help
    - Indeed it can, provided we know which models to compare:
...
- Blindly using all 600 predictors doesn't work very well, so do we make the problem manageable?
    ...
    - Automated approaches aren't a cure-all, oftentines the best approach is apply content area knowledge and use residuals plots 
