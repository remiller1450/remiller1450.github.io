...
x = data.frame(Date = c("1/31", "2/2", "2/7", "2/9", "2/14"), 
               Lecture = c("[k-Nearest Neighbors](ml23/mod.pdf)", "[Cross-Validation](ml23/cv.pdf)", " ", "[Classifier Performance](ml23/cm.pdf)", "Feature Engineering"),
               Lab = c("[kNN and Pre-processing](ml23/lab2a.html)", "[Pipelines, Cross-validation, and Tuning Parameters](ml23/lab2b.html)", " ", "[Classifier Performance](ml23/lab3a.html)", "Feature Engineering Challenge"))
kable(x) %>%
  kable_styling(bootstrap_options = c("striped", "hover"))
```
...
- Lab 2 (parts 1 and 2), Lab 3 (parts 1 and 2) - due Friday 2/17 by midnight
