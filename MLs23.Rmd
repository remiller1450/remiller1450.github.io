...
Please recognize that this course is completely new. So, after all of a unit's lectures have been completed, we may devote an additional 1-2 class periods towards finishing up that unit's labs and answering unresolved questions.

**Unit #1** - Introduction and Python Foundations

- Lectures: Intro (1/24)
- Labs: Scattered Python Foundations (1/26)
...
- Labs: kNN and scaling (1/31), Pipelines, Cross-Validation and Tuning Parameters (2/1), Classifer Performance (2/7), Feature Engineering Challenge (2/9)
...
- [Intro to Statistical Learning, Ch2.2 and 2.3](https://hastie.su.domains/ISLR2/ISLRv2_website.pdf)
