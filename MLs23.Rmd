...
Please recognize that this course is new. So, after all of a unit's lectures have been completed, we may need devote an additional 1-2 class sessions towards finishing up that unit's labs and answering unresolved questions.
...
- Lectures: [$k$-Nearest Neighbors (1/31)](ml23/mod.pdf), [Cross-Validation (2/2)](ml23/cv.pdf), [Classifier Performance (2/9)](ml23/cm.pdf), Feature Engineering (2/14)
- Labs: [kNN and Pre-processing (1/31)](ml23/lab2a.html), [Pipelines, Cross-validation, and Tuning (2/2)](ml23/lab2b.html), [Classifier Performance (2/9)](ml23/lab3a.html), Feature Engineering Challenge (2/14)
    - Tentative due-date: Friday 2/17 by midnight
- Homework: [Homework #1](ml23/hw1.html)
    - Tentative due-date: Tuesday 2/21 by 1pm
