...
x = data.frame(Date = c("2/21", "2/23", "2/28", "3/2", "3/7"), 
               Lecture = c("[Regression and Gradient Descent Algorithms](ml23/lm.pdf)", "Logistic and Softmax Regression", "Regularization", "No class (working differently day)",  "Feature Expansion"),
               Lab = c("[Linear Regression and Gradient Descent](ml23/lab4a.html)", "Logistic and Softmax Regression", "Lasso, Ridge, and Elastic Net"," ",  "Splines, Polynomials, and Discretization"))
kable(x) %>%
  kable_styling(bootstrap_options = c("hover"))
```
