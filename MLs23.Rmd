...
x = data.frame(Date = c("3/14", "3/16", "-"), 
               Lecture = c("[Decision Tree Models](ml23/trees.pdf)", "Ensembles", "Boosting"),
               Lab = c("[Decision Trees](ml23/lab6a.html)", "Ensembles, Stacking, and Random Forests", "XGBoost Challenge"))
kable(x) %>%
  kable_styling(bootstrap_options = c("hover"))
```
