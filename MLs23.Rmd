...
x = data.frame(Date = c("2/21", "2/23", "2/28", "3/2", "3/7"), 
               Lecture = c("[Regression and Gradient Descent Algorithms](ml23/lm.pdf)", "[Logistic and Softmax Regression](ml23/glm.pdf)", "Regularization", "No class (working differently day)",  "Feature Expansion"),
