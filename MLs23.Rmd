...
- Lectures: [$k$-Nearest Neighbors (1/31)](ml23/mod.pdf), Cross-Validation (2/1), Classifier Performance (2/7), Feature Engineering (2/9)
- Labs: [kNN and Pre-processing (1/31)](ml23/lab2a.html), Pipelines, Cross-Validation and Tuning Parameters (2/1), Classifier Performance (2/7), Feature Engineering Challenge (2/9)
