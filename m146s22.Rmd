...
- Exam #3 Topics:
    - [Two-sample testing procedures](m146s22/two_sample.pdf)
    - [Chi-squared tests](m146s22/chi_sq.pdf)
    - [Measuring association in contingency tables](m146s22/odds.pdf)
    - [Analysis of variance (ANOVA)](m146s22/anova.pdf)
...
- [Lab #5 - Analysis of one-sample data](m146s22/Lab5.html)
    - Due Date: Friday 3/25
- [Lab #6 - Analysis of two-sample data](m146s22/Lab6.html)
    - Due Date: Monday 4/4
- [Lab #7 - Chi-squared tests](m146s22/Lab7.html)
    - Due Date: Wednesday 4/13
- [Lab #8 - ANOVA](m146s22/Lab8.html)
...
- Homework #9: 7.13, 7.16, 7.19, 7.22 7.45, 7.46, 7.51, 7.54, 7.57, 7.58
    ...
    - Note: some questions may involve data from [this page](https://www.lock5stat.com/datapage3e.html)
...
- Exam #2 - Monday 3/28 during class
    - This exam is computer-based, open notes, and requires the use of StatKey
    - A practice exam (with solutions) is available under the "Quizzes" tab on Canvas
- Exam #3 - Friday 4/29 (open from 7am to 4pm)
    - This exam is computer-based, open notes, and requires the use of StatKey
    - A practice exam (with solutions) is available under the "Quizzes" tab on Canvas
...
- Projects are due by the end of the day on your section's assigned final exam time slot:
    - Monday, May 2 for Math-146-01
    - Wednesday, May 4 for Math-146-02
