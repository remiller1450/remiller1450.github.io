...
- Nicole (Nicky) Moreno Gonzalez (Sec-03) morenoni\@grinnell.edu
    - Each mentor will host a weekly help session, you are welcome to attend either mentor's session. The dates and times of these sessions will be posted when available.
...
- Exam 2 content:
    - Confidence intervals, hypothesis testing, p-values, testing errors, hypothesis testing misconceptions, 1-sample and 2-sample Z and T tests
- Exam 3 content:
