...
- Exam #1 Topics:
    ...
    - [Discrete random variables](m156s22/prob3.pdf)
    - [Continuous random variables and Normal models](m156s22/normal.pdf)
    - [Confidence interval estimation](m156s22/conf_int.pdf)
- Exam #2/Final Project Topics:
    - [The scientific method](m156s22/scientific_method.pdf)
    - [Hypothesis testing (concepts)](m156s22/ht.pdf)
    - [Z-tests and T-tests for one group](m156s22/one_sample.pdf)
    - Z-tests and T-tests for comparing groups
...
- Lab #2 - [Multivariate Relationships and Confounding Variables](m156s22/Lab2.html)
    - Due date: Monday 2/7
- Lab #3 - [Probability Practice](m156s22/Lab3.html)
    - Due date: Monday 2/28
- Lab #4 - [Applying Probability Models](m156s22/Lab4.html)
    - Due date: Monday 3/14
- Lab #5 - [Confidence Intervals](m156s22/Lab5.html)
    - Due date: Friday 3/28
- Lab #6 - [Hypothesis Testing](m156s22/Lab6.html)
    - Due date: Wednesday 4/6
- Lab #7 - [One-sample Hypothesis Tests](m156s22/Lab7.html)
    - Due date: Wednesday 4/20
- Lab #8 - Two-sample Hypothesis Tests
    - Due date: TBD
...
- Exam #3/Final Project:
    - Week 10: 18.1, 18.2, 18.5, 18.6, 19.1, 19.2, 19.3, 19.4
    - Week 11: 18.3
...
- Homework #8: 18.36, 18.38, 18.40, 20.37, 20.38, 20.59, 20.70, 20.72, 20.77
    - Due date: Friday 4/22 at 11:59pm
...
- Exam #1 - Scheduled for Friday 3/25 during class
    - [Practice exam](m156s22/Practice_Exam1.pdf)
    - [Practice solution](m156s22/Practice_Exam1_soln.pdf)
- Exam #2 - Will take place during the last week of classes (April 25 - 29)
...
- Final Project
    - [Information](m156s22/final.html)
