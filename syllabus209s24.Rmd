...
More simply, the fundamental aim of this course is to prepare students to independently perform basic data analyses using justifiable statistical methods.
...
At least 50% of in-class time will be devoted towards "lab" activities that entail working in a group of 2-3 to progress through guided exercises involving the analysis of data using `R`. You are responsible for the content that appears in these labs on exams, so it essential that you and your partner(s) work together and make certain that everyone understands each topic in sufficient detail. For most of the semester lab partners will be assigned, but you will have an opportunity to select your own lab partners towards the end of the semester.
...
Software is an essential tool in statistics, and it will play an important role in this course.  We will primarily use `R`, an open-source statistical software program. You will also be expected to write, document, and submit code used on assignments and a course project.
...
Exams may contain open-notes sections involving the use of a computer (R Studio) as well as closed-notes sections (formulas will be provided as necessary) depending upon the nature of the material being tested.
