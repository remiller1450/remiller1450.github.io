...
- [Personal growth reflection #1](s330s25/refl1.pdf)
    - Due Friday 3/7 at 11:59pm (via P-web)
- [Takeover memo and presentation](s330s25/takeover.pdf)
    - Memo is due Tuesday 4/8 at 11:59pm (via P-web)
    - Presentations are Tuesday 4/8 during class
- [Personal growth reflection #2](s330s25/refl2.pdf)
    - Due Friday 4/25 at 11:59pm (via P-web)
- [Personal growth reflection #3](s330s25/refl3.pdf)
    - Due Friday 5/16 at 5pm (via P-web)
- [Final products](s330s25/final.html)
    - Due Friday 5/16 at 5pm (via P-web)
...
tab <- data.frame(Date = c("Thursday 2/6", "Tuesday 2/11", "Thursday 2/13",
                  ...
                  Group = c("Bioinformatics","ITS tickets",
                            ...
                            "Baseball", "Database", "Bioinformatics", "-", "ITS Tickets", "Baseball", "-", "-", 
                             "Database","Bioinformatics","ITS tickets","Baseball", 
                            "Database","Bioinformatics","ITS tickets", "Baseball", "Database", "All groups"),
                  Briefing = c(rep(1,4), rep(2,4), 3, "-", rep(3,2), "-", "-", 3, rep(4,4), rep(5,4), "Final Presentations"))
