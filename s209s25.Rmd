...
x = data.frame(Date = c("Mon 1/20", "Wed 1/22", "Fri 1/24"), 
               ...
               Lab = c(" ", 
                       "[Lab 1 - Introduction to R](s209s25/intro.html)",
                       "[Lab 2 - Intro to `ggplot`](s209s25/ggplot.html)"),
               Resources = c(" ", " ", " "))
kable(x) %>%
...
- [Homework 1](s209s25/hw1.html) is due Friday 1/25 at 11:59pm

$~$

**Week 2** - Multivariate Data Visualizations and Contingency Tables
...
x = data.frame(Date = c("Mon 1/27", "Wed 1/29", "Fri 1/31"), 
               ...
               Lab = c("[Lab 3 - Multivariate Visualizations](s209s25/multi_viz.html))", 
                       "[Lab 4 - Tables and R Markdown](s209s25/tables.html)",
                       " "),
               Resources = c(" ", " ", " "))
kable(x) %>%
  kable_styling(bootstrap_options = c("hover"))
