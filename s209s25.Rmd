...
x = data.frame(Date = c("Mon 4/21", "Wed 4/23", "Fri 4/25"), 
               Lecture = c("[Inference for Linear Regression (F-tests)](s209s25/reg_inf.pdf)", "[Inference for Linear Regression (t-tests)](s209s25/reg_inf2.pdf)", "Logistic Regression (part 1)"),
