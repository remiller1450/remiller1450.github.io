...
x = data.frame(Date = c("Mon 2/24", "Wed 2/26", "Fri 2/28"), 
               Lecture = c("[Random Processes, Probability, and Sampling](s209s25/sampling.pdf)", " ", 
                           "[Interval Estimation](s209s25/conf.pdf)"),
...
x = data.frame(Date = c("Mon 3/3", "Wed 3/5", "Fri 3/7"), 
               Lecture = c(" ", "Bootstrapping", 
                           " "),
               Lab = c("Lab 10 - Confidence Intervals using CLT", 
                       "Lab 11 - Bootstrapping",
                       " "),
...
- Labs 9 and 10 are due *Friday 3/7 at 11:59pm*
