...
- Lab Submission #4 (due Tuesday 10/1)
    - All questions from the Making Maps lab (Extra credit for doing the [Making Tables](s230f19/tables.html) lab)
- Lab Submission #5 (due *Friday* 10/21)
    - All questions from the String Processing and Web Scraping labs
