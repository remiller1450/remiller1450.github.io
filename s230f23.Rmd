...
- Introduction to `R`
    - [Lab 1 (intro to R, Part 1)](s230f23/intro.html) and [Lab 1 (Part 2)](s230f23/intro2.html)
...
- Data visualization
    - [Lab 2 (intro to `ggplot2`)](s230f23/ggplot.html) and  [Lab 3 (effective data visualizations)](s230f23/ggplot2.html)
...
1. Data cleaning and visualization take-home (midterm #1)
    - Tentatively planned for either Tuesday 9/26 or Thursday 9/28
