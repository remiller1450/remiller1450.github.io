...
**Sampling from a population** (covered Friday 2/23) will be a topic on Exam 2, along with the following content:

**Week 6**:

```{r, echo = FALSE, message = FALSE, warning = FALSE}
x = data.frame(Date = c("Mon 2/26", "Wed 2/28", "Fri 3/1"), 
               Lecture = c("Interval Estimation",
                           "Bootstrapping",
                           " "),
               Lab = c(" ", 
...
- Week 6 labs (Confidence Intervals) and Lab 9 from Friday 2/23
