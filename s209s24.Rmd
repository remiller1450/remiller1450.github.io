...
x = data.frame(Date = c("Mon 3/4", "Wed 3/6", "Fri 3/8"), 
               Lecture = c("[Student's $t$-distribution](s209s24/normal_ci2.pdf)",
                           " ",
                           "[Null hypotheses and $p$-values](s209s24/ht1.pdf)"),
...
- **Exam 2**: Tentatively planned for *Monday 4/8* during class (1-2:20pm)
    - A practice exam and study guide will be posted at least 2 weeks prior to the exam
