...
x = data.frame(Date = c("Mon 4/29", "Wed 5/1", "Fri 5/3"), 
               Lecture = c("Outliers, Transformations, and Non-parametric tests",
                           "Hypothesis Testing for Regression Models",
                           " "),
               Lab = c(" ", 
                       "Transformations, Non-parametric tests, and Regression", "Transformations, Non-parametric tests, and Regression (cont)"))
kable(x) %>%
  kable_styling(bootstrap_options = c("hover"))
```
...
- Project Final Reports are due Friday 5/17 at 5pm
