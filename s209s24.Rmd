...
- Week 3 labs (`dplyr`, correlation and regression, multivariate relationships)
...
- Note: Exam #1 is currently planned for Monday 2/19 and will cover all material from Weeks 1-4. Expect the exam to focus on data visualizations (univariate and bivariate) and describing associations (contingency tables, group differences, correlation, and regression).

### Exam #2 Content

Topics:

- Sampling, randomized experiments, variability, confidence intervals, 1-sample and 2-sample hypothesis tests
...
- **Exam 1**: Planned for *Wednesday* 2/21 during class
    - A practice exam will be posted here by the end of this week
