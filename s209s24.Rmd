...
- Exam 1 will take place in *Noyce 2022* at 1pm on Wednesday 2/21
   - You may use a basic calculator (but not one that can store data). If you don't have a suitable calculator, some from the science division will be available during the exam.
