...
x = data.frame(Date = c("Mon 2/19", "Wed 2/21", "Fri 2/23"), 
               Lecture = c("[Exam 1 Review](s209s24/exam1_revq.html)", 
                           "Exam 1",
...
- If you don't have a suitable calculator, some from the science division will be available during the exam.
