...
- Unit #1 - Introduction, Fundamentals, and Models for Tabular Data
    ...
    - Model explainability (Permutation approaches, PDP, ICE, LIME, SHAP)
...
3. *“Why Should I Trust You?” Explaining the Predictions of Any Classiﬁer* by Ribeiro, Singh, and Guestrin (2016)
4. *ImageNet Classification with Deep Convolutional Neural Networks* by Krizhevsky, Sutskever, and Hinton (2012)
5. *On the Dangers of Stochastic Parrots:Can Language Models Be Too Big?* by Bender, Gebru, McMillan-Major, and Shmitchell (2021)
