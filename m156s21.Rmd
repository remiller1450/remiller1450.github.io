...
- Week 2 - Watch these prior to taking the "Week 2 Quiz" on Canvas (deadline Tuesday 1/26 at 8:30am)
    - Data Basics - [slides](m156s21/week1.pdf)
    - Quantitative Variables - [slides](m156s21/week1.pdf) 
    - Categorical Variables - [slides](m156s21/week1.pdf) 
    - Contingency Tables - [slides](m156s21/week1.pdf) 
- Week 3 - Watch these prior to taking the "Week 3 Quiz" on Canvas (deadline Tuesday 2/2 at 8:30am)
    - Comparing Groups - [slides](m156s21/week2.pdf)
    - Correlation - [slides](m156s21/week2.pdf) 
    - Regression - [slides](m156s21/week2.pdf)
- Week 4 - Watch these prior to taking the "Week 4 Quiz" on Canvas (deadline *Thursday* 2/9 at 8:30am)
    - Sampling from a Population - [slides](m156s21/week3.pdf)
    - Sampling Examples - [slides](m156s21/week3.pdf) 
    - Study Design - [slides](m156s21/week3.pdf)
    - Randomized Experiments - [slides](m156s21/week3.pdf)
- Week 5 - Watch these prior to taking the "Week 5 Quiz" on Canvas (deadline Tuesday 2/16 at 8:30am)
    - Introduction to Probability - [slides](m156s21/week4.pdf) 
    - The Complement Rule  - [slides](m156s21/week4.pdf) 
    - The Addition Rule - [slides](m156s21/week4.pdf) 
    - The Multiplication Rule - [slides](m156s21/week4.pdf) 
    - Probability Rules Examples - [slides](m156s21/week4.pdf) 
- Week 6 - Watch these prior to taking the "Week 6 Quiz" on Canvas (deadline *Thursday* 2/23 at 8:30am)
    - Discrete Random Variables - [slides](m156s21/week5.pdf)
    - Continuous Random Variables - [slides](m156s21/week5.pdf) 
    - Applications of the Normal Model - [slides](m156s21/week5.pdf) 
- Week 7 
...
- Week 8
    - Sampling Distributions - [slides](m156s21/week8.pdf)
    - Central Limit Theorem - [slides](m156s21/week8.pdf) 
    - Point vs. Interval Estimates - [slides](m156s21/week8.pdf) 
- Week 9
    - Hypothesis Testing - Null Models - [slides](m156s21/week9.pdf) 
    - Hypothesis Testing - p-values - [slides](m156s21/week9.pdf) 
    - Hypothesis Testing - Procedural Steps - [slides](m156s21/week9.pdf) 
    - Hypothesis Testing - Decision Errors - [slides](m156s21/week9.pdf) 
    - Hypothesis Testing - Common Misconceptions - [slides](m156s21/week9.pdf) 
- Week 10
    - The $Z$-test for one-sample categorical data - [slides](m156s21/week10.pdf) 
    - Example #1 - [slides](m156s21/week10.pdf) 
    - Example #2 - [slides](m156s21/week10.pdf)
    - Example #3 - [slides](m156s21/week10.pdf)
- Week 11
    - The $t$-distribution - [slides](m156s21/week11.pdf)
    - The one-sample $t$-test - [slides](m156s21/week11.pdf)
    - Assumptions and the $t$ and $z$ tests - [slides](m156s21/week11.pdf)
    - Simulation-based alternatives (optional) - [slides](m156s21/week11.pdf)
- Week 12
    - Two-sample categorical data - [slides](m156s21/week12.pdf)
    - The difference in proportions Z-test - [slides](m156s21/week12.pdf)
    - Confidence intervals and odds ratios - [slides](m156s21/week12.pdf)
- Week 13
    - Midterm #2 on Tuesday, Academic Holiday on Thursday
- Week 14
    - Two-sample quantitative data (the two-sample T-test) - [slides](m156s21/week14.pdf)
    - Two-sample quantitative data (confidence intervals) - [slides](m156s21/week14.pdf)
- Week 15
    - Inference for the correlation coefficient - [slides](m156s21/week15.pdf)
    - Inference for simple linear regression - [slides](m156s21/week15.pdf)
