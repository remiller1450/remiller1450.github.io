...
x = data.frame(Date = c("Thursday 8/24", 
               ...
               Content = c("1. Introduction <br> 2. Productive Discussions <br> 3. Discussion", 
                          "1. Outlining an Argument Activity <br> 2. Descriptive Statistics <br> 3. NYPD Activity",
               ...
               Assignments = c(" ", 
                               "NYPD Introduction Paragraph",
                               "NYPD Deceptive Strategies Reflection",
                               "Presentation #1",
